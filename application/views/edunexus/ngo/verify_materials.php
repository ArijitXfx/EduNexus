<head>
	...
	<script type="text/javascript" src="<?php echo base_url()?>resources/js/verify_materials.js?version=2"></script>
...
<body onload="load();">
    ...
    <div class="container">
    	...
    	<h1 id="bodyheading">Verify Materials</h1>
